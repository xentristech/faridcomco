...
const es = {
  ...
  projects: {
    ...
    items: [
      ...
      { name: "Sinagoga Beit Jasdó", tag: "Sitio comunitario · con IA", desc: "Web trilingüe (español, inglés y hebreo) de la comunidad judía de Barranquilla: horarios de Shabat, curso de hebreo, blog, galería y \"Moré\", un asistente de IA que explica festividades y conceptos judaicos.", seed: "sinagoga-beit-jasdo-comunidad", url: "https://sinagogabeitjasdo.com" },
      { name: "AutoSGSST", tag: "App con IA · SG-SST", desc: "Automatiza el SG-SST con visión por computadora y voz: convierte fotos y entrevistas en informes legales en Word, PDF y audio.", seed: "autosgsst-safety-ai-vision", url: "https://autosgsst.vercel.app" },
...
const en: typeof es = {
  ...
  projects: {
    ...
    items: [
      ...
      { name: "Sinagoga Beit Jasdó", tag: "Community site · with AI", desc: "Trilingual site (Spanish, English and Hebrew) for the Jewish community of Barranquilla: Shabbat schedules, a Hebrew course, blog, gallery and \"Moré\", an AI assistant that explains Jewish holidays and concepts.", seed: "sinagoga-beit-jasdo-comunidad", url: "https://sinagogabeitjasdo.com" },
      { name: "AutoSGSST", tag: "AI app · OSH", desc: "Automates workplace safety compliance with computer vision and voice: turns photos and interviews into legal reports in Word, PDF and audio.", seed: "autosgsst-safety-ai-vision", url: "https://autosgsst.vercel.app" },
