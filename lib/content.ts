...
const es = {
  ...
  projects: {
    ...
    items: [
      ...
      { name: "AutoSGSST", tag: "App con IA · SG-SST", desc: "Automatiza el SG-SST con visión por computadora y voz: convierte fotos y entrevistas en informes legales en Word, PDF y audio.", seed: "autosgsst-safety-ai-vision", url: "https://autosgsst.xentris.tech" },
...
const en: typeof es = {
  ...
  projects: {
    ...
    items: [
      ...
      { name: "AutoSGSST", tag: "AI app · OSH", desc: "Automates workplace safety compliance with computer vision and voice: turns photos and interviews into legal reports in Word, PDF and audio.", seed: "autosgsst-safety-ai-vision", url: "https://autosgsst.xentris.tech" },
