...
export const projects = [
  {
    name: "Xentris Tech",
    tag: "Empresa de tecnología",
    desc: "Software a medida, infraestructura cloud, IA y estrategia digital para empresas.",
    seed: "xentris-ai-platform-blue",
    url: "https://xentris.tech",
  },
  {
    name: "Platim.co",
    tag: "Web corporativa · B2B",
    desc: "Dotaciones, uniformes, calzado y EPP de seguridad industrial en Colombia.",
  ...
  },
  {
    ...
    tag: "Web corporativa",
    desc: "Venta, alquiler, repuestos y taller de montacargas para bodegas, puertos e industria.",
  ...
  },
  {
    name: "Neona.Tech",
    tag: "Estudio de IA",
    desc: "Estudio de inteligencia artificial. Muy pronto.",
