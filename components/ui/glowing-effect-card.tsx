...
// GlowingEffect — borde con glow que sigue al cursor (estilo 21st.dev / Aceternity),
// adaptado a la paleta de la marca (azul/violeta/cyan). Autocontenido, sin deps extra.
